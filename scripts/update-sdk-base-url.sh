...
file="$(pwd)/node_modules/@whereby.com/core/dist/index.mjs"
...
if [ -z "$API_BASE_URL" ]; then
    ...
    sed -i.bak "s|${prodApiBaseUrl}|${localApiBaseUrl}|g" $file
...
if [ -z "$SIGNAL_BASE_URL" ]; then
    ...
    sed -i.bak "s|${prodSignalBaseUrl}|${localSignalBaseUrl}|g" $file
